...
public class TopFragment extends Fragment {
    ...
    public void loadRecyclerViewsMovies(int recyclerIndex, int page) {
        ...
        switch (recyclerIndex) {
            case 0:
                retrofitService.getPopularMovies(page, KEY_API, "US").enqueue(getMoviePageCallback(recyclerIndex, page));
                break;
            case 1:
                retrofitService.getTopRatedMovies(page, KEY_API, "US").enqueue(getMoviePageCallback(recyclerIndex, page));
                break;
            case 2:
                retrofitService.getDiscoverEigthiesMovies(page, KEY_API, "vote_count.desc", "US",
