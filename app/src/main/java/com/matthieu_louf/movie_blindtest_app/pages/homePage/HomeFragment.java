...
public class HomeFragment extends Fragment {
    private BlindtestParameters[] blindtestParameters = new BlindtestParameters[]{
            new BlindtestParameters(1, R.string.top_rated_cardname, R.mipmap.infiltres, 4, "vote_average.desc", "", "", "", "", ""),
            // new BlindtestParameters(2, R.string._2020, R.mipmap.birds_of_prey, 2, "popularity.desc", "2020-01-01", "2020-12-31", "", "", ""),
            new BlindtestParameters(3, R.string._2019, R.mipmap.parasite, 2, "popularity.desc", "2019-01-01", "2019-12-31", "", "", ""),
            ...
            new BlindtestParameters(6, R.string.crime_thriller_cardname, R.mipmap.thriller_crime, 4, "vote_average.desc", "1960-01-01", "", "80,53", "", ""),
            new BlindtestParameters(7, R.string.american_comedy_cardname, R.mipmap.comedy, 2, "vote_average.desc", "1980-01-01", "", "35", "16", "en"),
            new BlindtestParameters(8, R.string.romance_cardname, R.mipmap.romance, 2, "vote_average.desc", "1980-01-01", "", "10749", "", ""),
            new BlindtestParameters(9, R.string.western_cardname, R.mipmap.western, 2, "vote_average.desc", "1960-01-01", "", "37", "", ""),
            new BlindtestParameters(10, R.string.horror_cardname, R.mipmap.halloween, 2, "vote_average.desc", "1980-01-01", "", "27", "", ""),
            ...
            new BlindtestParameters(14, R.string.heigthies_cardname, R.mipmap.indiana_jones, 4, "vote_average.desc", "1980-01-01", "1989-12-31", "", "", "en"),
            new BlindtestParameters(15, R.string.american_movies_30_60_cardname, R.mipmap.american_30_60, 2, "vote_average.desc", "1930-01-01", "1959-12-31", "", "", "en"),
            ...
            new BlindtestParameters(17, R.string.worst_movies_cardname, R.mipmap.worst_movie, 4, "vote_average.asc", "1980-01-01", "", "", "", "")
    };
